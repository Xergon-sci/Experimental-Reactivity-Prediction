...
VERSION = '0.0.3'
MODELTITLE = 'Predicting Alpha occ. energies'
...
train_labels = train['homo'].to_numpy(dtype=np.float).tolist()
train_labels = np.array(train_labels)
log.info('Converting test labels to array...')
test_labels = test['homo'].to_numpy(dtype=np.float).tolist()
