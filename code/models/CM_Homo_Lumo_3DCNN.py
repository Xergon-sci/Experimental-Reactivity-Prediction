...
# Drop unused data
data = data[['coulomb_matrix', 'homo', 'lumo']]
...
train_labels = train[['homo', 'lumo']].to_numpy(dtype=np.float).tolist()
train_labels = np.array(train_labels)
log.info('Converting test labels to array...')
test_labels = test[['homo', 'lumo']].to_numpy(dtype=np.float).tolist()
